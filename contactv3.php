<?php $votre_adresse_mail = 'contact@meteoben-web.fr';
    ...
    if (empty($_POST['mail'])) {
        ...
        echo "<p>Le champ nom est vide.</p>";
             //on vérifie que le champ name n'est pas vide
                ...
                echo "<p>Le champ phone est vide.</p>";
        ...
        $entetes_du_mail[] = 'From: Contact depuis Epu-crestois.fr <' . $votre_adresse_mail . '>';
        $entetes_du_mail[] = 'Reply-To: Nom de votre site <' . $mail_de_lutilisateur . '>';
        $entetes_du_mail[] = 'X-Mailer: PHP/' . phpversion() . '\r\n';
        ...
        if (mail($votre_adresse_mail, $sujet, $message, $entetes_du_mail)) {
            // header('Location: https://meteoben.fr/');
